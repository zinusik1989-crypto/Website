...
(function () {
  ...
  const defaults = {
    ...
    song1_cover: "./songs/covers/koroleva-arktiki.webp?v=2",
    ...
    song2_cover: "./songs/covers/den-rozhdeniya-irina.webp?v=2",
    ...
    song3_cover: "./songs/covers/severnaya-shamanka.webp?v=2",
    ...
    song4_cover: "./songs/covers/govorili-tishe.webp?v=2",
    ...
    song5_cover: "./songs/covers/demebelskiy-vokzal.webp?v=2",
