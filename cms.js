...
(function () {
  ...
  const defaults = {
    ...
    song1_cover: "./songs/covers/koroleva-arktiki.webp?v=3",
    ...
    song2_cover: "./songs/covers/den-rozhdeniya-irina.webp?v=3",
    ...
    song3_cover: "./songs/covers/severnaya-shamanka.webp?v=3",
    ...
    song4_cover: "./songs/covers/govorili-tishe.webp?v=3",
    ...
    song5_cover: "./songs/covers/demebelskiy-vokzal.webp?v=3",
    ...
    song6_cover: "./songs/covers/murmansk-zapominaet.webp?v=4",
    ...
    song7_cover: "./songs/covers/pozvoni-poka-ne-pozdno.webp?v=4",
